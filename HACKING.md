...
hidden if the `Sole_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Sole_DEVELOPER_MODE` to the configure
...
Runs the executable target `Sole_exe`.
